...
# Deployment Script for echoe Application
...
DEPLOY_TYPE="${1:-local}"
CONTAINER_NAME="echoe-app"
IMAGE_NAME="echoe:latest"
PORT="${PORT:-3200}"

echo -e "${BLUE}========================================${NC}"
echo -e "${BLUE}echoe Deployment Script${NC}"
echo -e "${BLUE}========================================${NC}"
...
deploy_docker_compose() {
    ...
    if docker-compose -f docker-compose.prod.yml ps | grep -q "echoe-app"; then
